...
public class Querybulider extends SlingSafeMethodsServlet {
	 ...
	 * Logger
	 */
	private static final Logger log = LoggerFactory.getLogger(Querybulider.class);
